    ...
    def create_bulk_read_job(
        ...
        try:
            ...
            if error_code in [2945, 2946]:  # OAuth scope errors
                ...
                logger.error(
                    "Your refresh token MUST have scope: ZohoCreator.bulk.READ"
                )
                logger.error("Regenerate token at: https://api-console.zoho.in/")
                return None
            ...
            for attempt in range(max_attempts):
                ...
                if current_status == "completed":
                    ...
                    if records:
                        ...
                        result["success"] = True
                        logger.info(f"No records in report: {report_name}")
    ...
    def export_all_data(self) -> Dict:
        ...
        try:
            ...
            if not all_reports_with_app:
                print("No reports found in any application")
                return self.stats
